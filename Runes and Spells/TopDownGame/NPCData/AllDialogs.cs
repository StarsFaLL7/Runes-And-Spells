...
public static class AllDialogs
{
    ...
    public static class WoodmanDialog
    {
        ...
        public static DialogPhrase FinalPhraseGood = new DialogPhrase(
            "Что говоришь, колдун какой-то распоясался? Да, я помогу тебе разобраться с ним", "Дровосек присоединился к вашей команде.", 
        ...
        public static void Initialize()
        {
            ...
            var phrase2 = new DialogPhrase(
                "Я начал замечать каких-то странных животных далеко в западной части леса.\n" +
                "Это какие-то монстры, на местных не похожи, а я, поверь, всех местных животных знаю!\n" +
                "А по пути туда я несколько раз видел какого-то подозрительного парня.\n" +
                "Советую тебе посмотреть, что там такое, точно чертовщина какая-то!",
                null,
            ...
            QuestFinishedBad = new DialogPhrase(
                "Твоя магическая фигня не сработала. Печальный из тебя волшебник, что сказать.\n" +
                "А отдувался за твою ошибку я! Повезло тебе, что мой топор всегда со мной!", null, endQuestAnswer);
            QuestFinishedGood = new DialogPhrase(
                ...
                "деревья не рубит - бесполезная выходит, но я подумал, может тебе нужна будет?",
                "Вы получили изумрудный ключ", endQuestAnswer);
            ...
            var questAcceptedPhrase = new DialogPhrase(
                ...
                "Слушай внимательно:\n" +
                "Эти волки сильно боятся огня, принеси мне что-нибудь, что поможет выгнать их!",
            ...
            var phrase4 = new DialogPhrase(
                "Я собираюсь найти и уничтожить их логово. Они создают хаос в этой местности,\n" +
                "и я не могу продолжать работу с этими бродягами рядом.\n" +
                "Если ты и правда магией занимаешься, может предложишь способ расправиться с ними?", null,
            ...
            var phrase5 = new DialogPhrase(
                "Меня зовут Иван, я местный дровосек.\n" +
                "Я заметил, что в лесу появилась стая диких волков.\n" +
                "Они становятся все более агрессивными и нападают на людей, проходящих мимо.", null,
    ...
    public static class FishermanDialog
    {
        ...
        public static DialogPhrase FinalPhraseBad = new DialogPhrase(
            "Борьба со злом - очень хорошее дело, но не стоит забывать о людях, для которых я ловлю рыбу.\n" +
            "Без меня им придётся туго, поэтому извини, но этот путь ты должен преодолеть без меня.", null, 
            new AnswerVariant("Хорошо, тогда помогай людям тут.", null, true));
        public static void Initialize()
        {
            QuestInProgressPhrase = new DialogPhrase(
            ...
            QuestFinishedGood = new DialogPhrase(
                ...
                "надеюсь, ты найдешь ему применение. Как говорится: \"Делай добро и жди добра\"",
                "Вы получили изумрудный ключ", endQuestAnswer);
            var questCanceledPhrase = new DialogPhrase(
            ...
            var questAcceptedPhrase = new DialogPhrase(
                ...
                "\"Там, где вода встречается с луной, скрыто могущество, ожидающее откровения\".\n" +
                ...
                new AnswerVariant("Хорошо! Я вернусь как можно раньше.", QuestInProgressPhrase, true,
                    npc => npc.IsQuestActive = true));
            var phrase4 = new DialogPhrase(
                "Да, умный ты парень, но вот не в моих это силах. Малфиус смог бы с этим помочь.\n" +
                "Моя проблема более низменная, рыба перестает водится в реке.\n" +
                "Малфиус помогал мне ее ловить при помощи магии океана.\n" +
                "Может, у тебя получится создать для меня свиток магии Океана, который помог бы мне увеличить улов?", null,
            ...
            var phrase5 = new DialogPhrase(
                ...
                "Я не знаю, кто или что стоит за всем этим, но чувствую, что власть зла усиливается.", null,
                new AnswerVariant("Тогда нам нужно противостоять злу, верно?", phrase4, false));
            
            var phrase6 = new DialogPhrase(
                "Хм, раз ты занимаешься магией, у меня есть для тебя просьба, юный волшебник.", null,
                new AnswerVariant("Слушаю", phrase5, false));
            var phrase7 = new DialogPhrase(
                "Хм, я даже и не знаю.\n" +
                "Но ты можешь встретиться с нашей целительницей или ведьмой, как ее некоторые называют.\n" +
                "Она живет в западной части леса. Я думаю, что она подскажет тебе способ перебраться через реку.",
                null,
                new AnswerVariant("Спасибо, попробую ее найти.", phrase6, false));
            var phrase8 = new DialogPhrase(
                "Его зовут Малфиус, хороший он человек, всегда всем помогает, но в последнее время куда-то пропал.\n" +
                "Занят, наверное. Его обычно можно встретить на другом берегу реки, но вот как тебе туда попасть...", null,
                new AnswerVariant("А какие есть варианты?", phrase7, false));
            var phrase9 = new DialogPhrase(
                "В далекие времена, когда тьма и свет сражались за владычество, великие маги создали особые \n" +
                "свитки - это такой способ хранить магию на пергаменте. \n" +
                "И до сих пор некоторые изучают и создают свитки, подобные тем, что были созданы первыми. \n" +
                "У меня есть знакомый волшебник, который часто помогает мне с рыбалкой при помощи этих свитков.", null,
                new AnswerVariant("Что за волшебник? Я могу с ним встретиться?", phrase8, false));
            var phrase10 = new DialogPhrase(
                "Хех, что уж тут понимать, видно по тебе, а у меня глаз в мои года уже хорошо наметан. \n" +
                "Хочешь расскажу тебе одну интересную историю из мира магии?", null,
            ...
            FirstPhrase = new DialogPhrase(
                ...
                "Пришел сюда в поисках чего-то особенного, а не просто поймать рыбку, да?", null,
    ...
    public static class HunterDialog
    {
        ...
        public static DialogPhrase FinalPhraseBad = new DialogPhrase(
            "Я все еще не поправился после сражения с монстрами, вряд ли я смогу вам помочь, извини.", null, 
        ...
        public static void Initialize()
        {
            ...
            QuestJustFinishedPhrase = new DialogPhrase(
                "Не уверен я, что этот свиток поможет, но попробовать, в любом случае, стоит.",
                null, new AnswerVariant("...", null, true));

            var endAnswer = new AnswerVariant("...", null, true);
            var endPhrase = new DialogPhrase(
                "Мы разбили этих страшных тварей! Мы заглянули в их синие глаза, и выжили!", null, endAnswer);
            var endQuestAnswer = new AnswerVariant("...", endPhrase, false, (npc =>
            {
                if (npc.IsQuestFinishedGood)
                {
            ...
            QuestFinishedBad = new DialogPhrase(
                "Что ты мне такое принес? Твой свиток не создал достаточно холода, чтобы монстры испугались.\n" +
                "Пришлось разбираться самому, хорошо, что обычными ранами отделался.\n" +
                "Но дело сделано, теперь путь в западную часть леса открыт.", null, endQuestAnswer);
            QuestFinishedGood = new DialogPhrase(
                "Ох, это было хорошо. Твой свиток отлично сработал.\n" +
                "Все монстры ушли, теперь ты можешь спокойно пройти на запад. Спасибо тебе за помощь!",
                "На земле, откуда убежали монстры вы нашли изумрудный ключ", endQuestAnswer);
            ...
            var phrase5 = new DialogPhrase(
                "Знаешь, я ловил множество зверей в своей жизни, но таких тварей еще не видывал.\n" +
                "Они выглядят страшно и агрессивно. И что самое интересное, они боятся холода!", null,
                new AnswerVariant("Хм, это интересно.\n" +
                                  "Я могу использовать свои знания рун и заклинаний, чтобы создать что-то, что отпугнет этих монстров.", phrase4, false));
            
            var phrase6 = new DialogPhrase(
                "Монстры, которых мы никогда раньше не видели. \n" +
                "Они приходят из какого-то другого измерения, и, мне кажется, только ты, волшебник, можешь нам помочь.", null,
                new AnswerVariant("Понимаю. Расскажите мне больше об этих существах.", phrase5, false));
            var phrase7 = new DialogPhrase(
                "Меня зовут Тормунд, обычно я занимаюсь охотой в других лесах,\n" +
                "но в последнее время в наших лесах появились странные существа, их след привел меня сюда.", null,
            ...
            FirstPhrase = new DialogPhrase(
                ...
                new AnswerVariant("Здравствуйте, да, я начал заниматься магией. Чем я могу быть полезен?", phrase7, false));
    ...
    public static class BardDialog
    {
        ...
        public static DialogPhrase FinalPhraseGood = new DialogPhrase(
            ...
            "чтобы во всем королевстве узнали, кто такой Бард Василек! Конечно я иду с вами!", "Бард присоединился к вашей команде.", 
            new AnswerVariant("Отлично, спасибо большое!", null, true, 
                npc =>
                {
                    if (!npc.GameCore.FinalTeam.Contains(npc)) 
        ...
        public static DialogPhrase FinalPhraseBad = new DialogPhrase(
            "Куда мне до подвигов, когда я две строчки срифмовать не могу. Знаешь, жизнь - боль.\n" +
            "Оставьте меня.", null, 
        ...
        public static void Initialize()
        {
            QuestInProgressPhrase = new DialogPhrase(
                ...
                "мог бы я вернуться в молодость, найти вдохновение или вообще хорошенько поспать...",
                null, new AnswerVariant("Секунду...", null, true));
            QuestJustFinishedPhrase = new DialogPhrase(
            ...
            var song1 = new DialogPhrase("Ну что? Все понял?", null,
                new AnswerVariant("Надо еще поразмыслить, но спасибо! Пойду искать Малфиуса", songEnd, false));
            ...
            QuestFinishedGood = new DialogPhrase(
                "Привет! Спасибо тебе за помощь! Я уже чувствую, как рифма льется из моих уст!\n" +
                "Теперь я смогу рассказать тебе, кто такой Малфиус!\n" +
                "И вот держи этот ключ, его попросил передать достойному волшебнику сам Малфиус.", null, endQuestAnswer);
            
            var questAcceptedPhrase = new DialogPhrase(
                "Отлично! Я так рад! так рад! Я буду ждать и верить, что ты мне сможешь помочь!\n" +
                "Мне бы какую-нибудь магию, как у фей, они такие легкие и так изящно парят в воздухе!", null,
            ...
            var questDeniedPhrase = new DialogPhrase(
                "Ладно, буду пробовать писать на бумаге. Если все-таки решишь мне помочь, возвращайся", null,
                new AnswerVariant("...", questInDeny, true));
            var phrase1 = new DialogPhrase(
                "Я совсем разучился создавать рифму. Не знаю, что такое, но это ужасно.\n" +
                "Помоги мне и я расскажу тебе о волшебнике Малфиусе в стихах!", null,
                new AnswerVariant("Я занимаюсь магией и могу создать для тебя волшебный свиток, который тебе поможет.", questAcceptedPhrase, false),
                new AnswerVariant("Извини, но я не знаю, чем тебе помочь. Попробуй больше практиковаться.", questDeniedPhrase, false)
                );
            ...
            FirstPhrase = new DialogPhrase(
                ...
                "Ой, привет. Ты пришел послушать самого великого Барда этого королевства, Василька?", null,
                new AnswerVariant("Здравствуй, скорее нет. Я ищу некого волшебника Малфиуса, знаешь такого?", phrase2, false));
    ...
    public static class WitchDialog
    {
        ...
        public static void Initialize()
        {
            QuestInProgressPhrase = new DialogPhrase(
                "Здравствуй, путник. \n" +
                "Напоминаю: моему клиенту нужна магия жизни, которая позволит влюбить в него девушку,\n" +
                "чем эффективнее, тем лучше.",
            ...
            var endPhrase = new DialogPhrase(
                "Бедные зайчики... \n" +
                "Нужно пойти накосить особую траву, чтобы они не боялись выходить из своих норок.", null, 
            ...
            var phraseQuestFinish = new DialogPhrase(
                ...
                "Чтобы использовать крылья, нажмите на пробел. Пока вы летаете, вы можете перейти на другой берег реки.",
                new AnswerVariant("Спасибо большое! Я уверен, что мы сможем победить зло в этих землях.", endPhrase, true, 
                    npc => npc.GameCore.PlayerHasWings = true));
            
            var endQuestAnswer = new AnswerVariant("Нам все еще нужно победить зло. Ты поможешь мне перебраться на другой берег реки?", phraseQuestFinish, false, (npc =>
            {
                if (npc.IsQuestFinishedGood)
                {
                    npc.GameCore.Game.Inventory.AddItem(new Item(ItemsDataHolder.OtherItems.KeyEmerald));
            ...
            QuestFinishedBad = new DialogPhrase(
                "Спасибо за твою помощь, но, кажется, твое заклинание не сработало нужным образом.\n" +
                "Клиент почти ничего не заплатил, и теперь мне снова нужно где-то искать деньги на жизнь", null, endQuestAnswer);
            QuestFinishedGood = new DialogPhrase(
                "Огромное спасибо тебе, путник. Твой заклинание сработало идеально.\n" +
                "Теперь у меня снова есть деньги на жизнь.\n" +
                "Вот, держи этот ключ. Клиент отдал его вместе с деньгами, он остался очень доволен.", null, endQuestAnswer);
            ...
            var phrase1 = new DialogPhrase(
                "Значит, ты ищешь Малфиуса? Ты можешь с ним поговорить на другом берегу реки.\n" +
                "Я могу помочь тебе переправиться через реку, если ты поможешь мне.", null,
            ...
            var phrase3 = new DialogPhrase(
                "Этот клиент обещал заплатить мне огромную сумму, если я помогу ему влюбить в себя девушку.\n" +
                "Ко мне приходят все меньше людей, все боятся заходить в лес после того, как началось что-то плохое.\n" +
            ...
            var phrase4 = new DialogPhrase(
                "Ты знаешь, я принимаю у себя жителей из города и помогаю им излечиться от болезней и травм.\n" +
                "Я живу на эти деньги, чтобы продолжать свою работу. Но сегодня ко мне пришел клиент с необычной просьбой.",
                null,
                new AnswerVariant("Что за просьба такая необычная?", phrase3, false));

            FirstPhrase = new DialogPhrase(
                "Добро пожаловать, путник. Меня зовут Вивиана. Я рада, что ты нашел меня.\n" +
                "Я видела, как ты помогал моим знакомым в этом лесу, и мне тоже нужна твоя помощь.", null,
    ...
    public static class TraderDialog
    {
        ...
        public static DialogPhrase QuestFinishedBad;
        public static DialogPhrase FinalPhraseGood = new DialogPhrase(
            "Ты спас самого близкого для меня человека. Никакая шкатулка этого не окупит.\n" +
            "Да, я пойду с вами, чтобы хоть немного оплатить свой долг перед тобой.", "Торговец присоединился к вашей команде", 
            new AnswerVariant("Отлично, спасибо большое!", null, true, 
                npc =>
                {
                    if (!npc.GameCore.FinalTeam.Contains(npc)) 
        ...
        public static DialogPhrase FinalPhraseBad = new DialogPhrase(
            "Ты не помнишь?! Моей жене очень плохо, мне не с кем ее оставить. Да и не хочу я идти с тобой.", null, 
            new AnswerVariant("Хорошо, я понял.", null, true));
        public static void Initialize()
        {
            QuestInProgressPhrase = new DialogPhrase(
                "Моей жене все хуже. Ну что-то вроде лечения или регенерации.",
                null, new AnswerVariant("Да, стараюсь как можно быстрее.", null, true));
            QuestJustFinishedPhrase = new DialogPhrase(
            ...
            QuestFinishedGood = new DialogPhrase(
                "Благодарю тебе, великий волшебник! Моя жена теперь чувствует себя прекрасно!\n" +
                "Как и обещал, держи эту шкатулку. Я уверен, ты достоен ее!", 
            ...
            var questAcceptedPhrase = new DialogPhrase(
                ...
                "Я не знаю, какие у тебя есть свитки, но мне нужно что-то вроде лечения или регенерации.", null,
                new AnswerVariant("Постараюсь найти что-нибудь подходящее.", QuestInProgressPhrase, true,
                    npc => npc.IsQuestActive = true));
            ...
            var phrase1 = new DialogPhrase(
                "Знаешь, дело в том, что я и не торговец вовсе.\n" +
                "Меня зовут Альфред, я продаю товары потому что у моей жены сильный кашель,\n" +
                "она не может встать с кровати, а лекарства очень дорогие.\n" +
                "Но я тут подумал, может, ты сможешь помочь ее исцелить?", null,
                new AnswerVariant("Хорошо, я постараюсь создать свиток, который поможет твоей жене", questAcceptedPhrase, false),
                new AnswerVariant("Может все-таки я куплю ее за золото?", questOnDeny, false));

            var phrase2 = new DialogPhrase(
                "Это древняя реликвия, она откроется только если ее в руки возьмет достойный волшебник.\n" +
                "Не желаешь проверить, достоен ли ты? Но за бесплатно я тебе ее не отдам.", null,
            ...
            FirstPhrase = new DialogPhrase(
                ...
                new AnswerVariant(
                    "Здравствуй, извини, но у меня совсем нет времени на твои безделушки.\n" +
    ...
    public static class Thief
    {
        ...
        public static DialogPhrase QuestFinishedBad;
        public static DialogPhrase FinalPhraseGood = new DialogPhrase(
            "Сначала поговорим об оплате?... Ладно-ладно, шучу, просто сделаешь мне еще одно заклинание\n" +
            "невидимости... Пожалуйста. И я помогу тебе победить этого Веракса!", "Вор присоединился к вашей команде", 
        ...
        public static DialogPhrase FinalPhraseBad = new DialogPhrase(
            ...
            "Там будет столько золота, сколько никто из нас не видел. Извини, но я не смогу вам помочь.", null, 
            new AnswerVariant("Хорошо, я понял.", null, true));
        public static void Initialize()
        {
            QuestInProgressPhrase = new DialogPhrase(
            ...
            QuestFinishedBad = new DialogPhrase(
                "Я не стал невидимым! Как и говорил, это нереально. Не получится ни у кого...", null, endQuestAnswer);
            QuestFinishedGood = new DialogPhrase(
                "Это было что-то! Меня вообще никто не видел! Я был как обычный воздух!\n" +
                "Жаль только, что дело пустышкой оказалось, в доме совсем не было ничего ценного.\n" +
            ...
            var interestingPhrase = new DialogPhrase(
                "О чем ты говоришь? Это нереально. Если бы я был невидимым, дела бы явно пошли в гору.", null, 
                new AnswerVariant("Дело в том, что я занимаюсь изучением магии и могу помочь тебе стать невидимым.", questAcceptedPhrase, false),
            ...
            var dontDisturb = new DialogPhrase("Ну не мешай. Я стараюсь быть как тень, стараюсь быть невидимым...", null, 
            ...
            var phrase1 = new DialogPhrase(
                ...
                "Намечается большое дело и мне нужно быть подготовленным. Эх, вот бы я был невидимым.", null,
    ...
    public static class MageDialog
    {
        ...
        public static void Initialize()
        {
            ...
            SecondQuestInProgressPhrase = new DialogPhrase(
                "Юный друг, ты принес мощное финальное заклинание, которое добьет Веракса?\n" +
                "У нас не так много времени.", null, new AnswerVariant("Да, уже совсем скоро будет готово.", null, true)
            );
            var secondQuest1 = new DialogPhrase(
                ...
                null, new AnswerVariant(
                    "Хорошо, я придумаю, какое заклинание нам стоит применить в конце,\n" +
                    "чтобы победить Веракса.", SecondQuestInProgressPhrase, true, npc => npc.IsSecondFinalQuestActive = true));
            FirstQuestFinished = new DialogPhrase(
                "У тебя получились отличные свитки. С их помощью мы сможем защититься от Веракса.\n" +
                "Но теперь нам нужен свиток, который при используем в самый последний момент,\n" +
                "чтобы поставить точку в нашей битве.",
                null, new AnswerVariant("...", secondQuest1, true,npc => npc.IsFirstFinalQuestActive = false));
            ...
            var phrase1 = new DialogPhrase(
                "Первый свиток должен защищать от магии, чтобы отразить колдовство Веракса.\n" +
                "Второй свиток должен оберегать от огня, потому что его огненные заклинания ужасны.\n" +
                "Третий свиток должен предохранять от мороза, ибо Веракс использует ледяные чары.\n" +
                "А четвертый свиток должен предостерегать от бури, чтобы укрыться от его ярости.", null,
                new AnswerVariant("Я понял, Малфиус. Я приму эту задачу на себя и создам необходимые свитки.",
            ...
            var phrase3 = new DialogPhrase(
                "Я заметил, что его аура искажена и источает зло, а сам себя он прозвал Мракотворцем.\n" +
            ...
            var phrase4 = new DialogPhrase(
                "Веракс когда-то давно был одним их моих учеников,\n" +
                ...
                "Он обладает невероятной магической силой и способностью манипулировать темными энергиями.", null,
                new AnswerVariant("...", phrase3, false));
            var phrase5 = new DialogPhrase(
                "О, мой юный друг, в этом мире появился злой колдун по имени Веракс Мракотворец.\n" +
                "Он открыл портал в темное измерение, из которого появляются монстры и разносят зло на своем пути.\n" +
                "Люди и животные живут в страхе, их мир погрузился во мрак. Но один я не смогу победить Веракса.", null,
                new AnswerVariant("Это звучит страшно, Малфиус. Зачем он это сделал?", phrase4, false));
            var phrase6 = new DialogPhrase(
                "Ах, вот и ты, мой юный друг!\n" +
                "Я знал, что ты придешь ко мне. В твоих глазах я вижу стремление к знаниям и силе.", null,
                new AnswerVariant(
                    "Добрый день, Малфиус.\n" +
                    "Я заметил, что в этих землях происходит что-то странное и искал ответы на все свои вопросы.", phrase5, false));
            ...
            var finalPhrase = new DialogPhrase(
                ...
                "Я верю в нашу силу и вижу, что ты достойный человек, и пусть свет и добро будут с нами.", null,
                new AnswerVariant("...", null, true));
            ...
            SecondQuestFinished = new DialogPhrase(
                ...
                "Может, у тебя есть знакомые в этом королевстве, кто не отказался бы нам помочь в борьбе со злом?", null,
                new AnswerVariant("Я думаю, найдется несколько.", prefinalInProgressPhrase, false, npc =>
                {
