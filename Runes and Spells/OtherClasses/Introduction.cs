...
public class Introduction
{
    ...
    public void LoadContent(ContentManager content)
    {
        ...
        AllTexts = new List<string>
        {
            ...
            "Нажмите на лужу глины, чтобы собрать случайное кол-во глины.",
            "Отлично! Теперь у нас есть немного глины, чтобы создать из нее руну.",
            "Руны создаются на специальном столе.",
            "Для того, чтобы создать руну, вам нужно положить глину в слот сверху,\nглина находится в вашем инвентаре в разделе \"Другое\"",
            "Теперь мы можем начать создание руны (Клик на кнопку)",
            ...
            "Чтобы создать заклинание, вам понадобится волшебный пергамент.",
            ...
            "Поздравляем! Вы создали заклинание. Заклинания можно продавать\nна торговой площади, давайте отправимся туда.",
            "Нам нужно выйти на улицу к нашей луже глины.",
